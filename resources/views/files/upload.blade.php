        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <label for="collection" class="floating-label">
                        <span>Collection (optional)</span>
                        <input type="text" id="collection" placeholder="Collection (optional)" class="input input-md">
                    </label>
                    <div role="tablist" class="tabs tabs-bordered">

                        <input type="radio" name="file_upload_tabs_1" role="tab" class="tab" aria-label="Upload File"
                            checked="checked" />
                        <div role="tabpanel" class="tab-content p-10">
                            <div class="col-span-full">
                                <span class="block text-sm font-medium text-gray-900 dark:text-gray-300">ISO
                                    Image</span>
                                <div id="drop-zone"
                                    class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-300 dark:border-gray-600 px-6 py-10 cursor-pointer bg-gray-50 dark:bg-gray-800">
                                    <div class="text-center">
                                        <svg class="mx-auto size-12 text-gray-400 dark:text-gray-500"
                        ...
                        <input type="radio" name="file_upload_tabs_1" role="tab" class="tab" aria-label="URL Import" />
                        <div role="tabpanel" class="tab-content p-10">
                            <label class="input">
                    ...
                    <div id="file-info"
                        class="hidden mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-900 dark:text-gray-200">
